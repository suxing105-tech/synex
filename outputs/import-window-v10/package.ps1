...
Copy-Item -LiteralPath (Join-Path $projectRoot 'frontend/src-tauri/binaries/python-backend-x86_64-pc-windows-msvc.exe') -Destination (Join-Path $packageRoot 'app/python-backend.exe') -Force
